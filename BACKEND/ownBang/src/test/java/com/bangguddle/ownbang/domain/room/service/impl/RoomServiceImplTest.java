...
class RoomServiceImplTest {
    ...
    void createRoomTest_SUCCESS() throws ParseException {
        ...
        RoomDetailCreateRequest roomDetailCreateRequest = new RoomDetailCreateRequest((byte) 1,(byte) 1,
        ...
        RoomCreateRequest roomCreateRequest = new RoomCreateRequest(DealType.월세, RoomType.오피스텔, Structure.분리형,
