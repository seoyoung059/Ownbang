...
export const agentReservationConfirm = async (reservationId) => {
    try {
        const response = await Axios.patch(`/agents/reservations/${reservationId}`, reservation.id);
        return response.data;
    } catch (error) {
...
export const agentReservationDeny = async (reservationId) => {
    try {
        const response = await Axios.patch(`/agents/reservations/delete/${reservationId}`);
        return response.data;
    } catch (error) {
