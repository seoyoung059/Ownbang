...
import { TableRow, TableCell, Avatar, Typography, Box, Button } from '@mui/material';
...
export default function AgentReservationItem({
    ...
    const getStatusIconAndText = (status) => {
        switch (status) {
            ...
            case 'APPLYED':
                return {
                    icon: <PendingOutlined style={{ color: theme.palette.warning.main }} />,
                    text: '대기 중',
                };
            case 'CANCELLED':
                return {
            ...
            case 'COMPLETED':
                return {
                    icon: <HistoryOutlined style={{ color: theme.palette.primary.dark }} />,
                    text: '통화 완료',
                };
            default:
                return {
    ...
    return (
        <TableRow>
            ...
            <TableCell>
                <Typography variant={'body1'}>{formatPhoneNumber(userInfo.phoneNumber)}</Typography>
            </TableCell>
            <TableCell>
